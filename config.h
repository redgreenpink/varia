...
#define GNULIB_ACCEPT IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module bind shall be considered present. */
#define GNULIB_BIND IN_XL_C_GNULIB_TESTS
...
#define GNULIB_CONNECT IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module fdopendir shall be considered present. */
#define GNULIB_FDOPENDIR IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module fd-safer-flag shall be considered present. */
#define GNULIB_FD_SAFER_FLAG IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module fscanf shall be considered present. */
#define GNULIB_FSCANF IN_XL_C_GNULIB_TESTS
...
#define GNULIB_FSTATAT IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module getcwd shall be considered present. */
#define GNULIB_GETCWD IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module ioctl shall be considered present. */
#define GNULIB_IOCTL IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module isblank shall be considered present. */
#define GNULIB_ISBLANK IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module listen shall be considered present. */
#define GNULIB_LISTEN IN_XL_C_GNULIB_TESTS
...
#define GNULIB_LSTAT IN_XL_C_GNULIB_TESTS
...
#define GNULIB_OPENAT IN_XL_C_GNULIB_TESTS
...
#define GNULIB_REALLOCARRAY IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module scanf shall be considered present. */
#define GNULIB_SCANF IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module select shall be considered present. */
#define GNULIB_SELECT IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module setsockopt shall be considered present. */
#define GNULIB_SETSOCKOPT IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module socket shall be considered present. */
#define GNULIB_SOCKET IN_XL_C_GNULIB_TESTS
...
#define GNULIB_STRERROR IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module strerror_r-posix shall be considered present. */
#define GNULIB_STRERROR_R_POSIX IN_XL_C_GNULIB_TESTS
...
#define GNULIB_XALLOC IN_XL_C_GNULIB_TESTS

/* Define to a C preprocessor expression that evaluates to 1 or 0, depending
   whether the gnulib module xalloc-die shall be considered present. */
#define GNULIB_XALLOC_DIE IN_XL_C_GNULIB_TESTS
...
#define PACKAGE_NAME "xl-c"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "xl-c 0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xl-c"
